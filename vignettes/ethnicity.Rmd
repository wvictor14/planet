...
information from `data(plPhenoData)`. Note that cpgs have been filtered to a random
...
##   <fct>     <chr> <chr>          <dbl>
## 1 GSM19449~ Male  preecl~           36
## 2 GSM19449~ Male  preecl~           32
## 3 GSM19449~ Fema~ preecl~           32
## 4 GSM19449~ Male  preecl~           35
## 5 GSM19449~ Fema~ preecl~           38
## 6 GSM19449~ Fema~ preecl~           36
## # ... with 3 more variables:
## #   ga_RPC <dbl>, ga_CPC <dbl>,
## #   ga_RRPC <dbl>
```
...
```
## # A tibble: 8 x 7
##   Sample_ID Predicted_ethni~
##   <chr>     <chr>           
## 1 GSM19449~ Asian           
## 2 GSM19449~ Caucasian       
## 3 GSM19449~ Asian           
## 4 GSM19449~ Caucasian       
## 5 GSM19449~ Caucasian       
## 6 GSM19449~ Caucasian       
## 7 GSM19449~ Caucasian       
## 8 GSM19449~ Caucasian       
## # ... with 5 more variables:
## #   Predicted_ethnicity <chr>,
## #   Prob_African <dbl>,
## #   Prob_Asian <dbl>,
## #   Prob_Caucasian <dbl>,
## #   Highest_Prob <dbl>
