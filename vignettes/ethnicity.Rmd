...
```
## # A tibble: 8 x 7
##   Sample_ID Predicted_ethni~ Predicted_ethni~
##   <chr>     <chr>            <chr>           
## 1 GSM19449~ Asian            Asian           
## 2 GSM19449~ Caucasian        Caucasian       
## 3 GSM19449~ Asian            Asian           
## 4 GSM19449~ Caucasian        Caucasian       
## 5 GSM19449~ Caucasian        Caucasian       
## 6 GSM19449~ Caucasian        Caucasian       
## 7 GSM19449~ Caucasian        Caucasian       
## 8 GSM19449~ Caucasian        Caucasian       
## # ... with 4 more variables: Prob_African <dbl>,
## #   Prob_Asian <dbl>, Prob_Caucasian <dbl>,
## #   Highest_Prob <dbl>
```
