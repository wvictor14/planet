...
test_that("pl_infer_ethnicity() calculates same output", {
  ...
  expect_equal(pl_infer_ethnicity(pl_betas)$Prob_African, p_af)
  ...
  expect_equal(pl_infer_ethnicity(pl_betas)$Prob_Asian, p_as)
  ...
  expect_equal(pl_infer_ethnicity(pl_betas)$Prob_Caucasian, p_ca)
