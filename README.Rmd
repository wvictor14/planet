...
For demonstration, I use 6/24 samples from a [placental DNAm dataset from GEO](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE75196) [2], which contains samples 
collected in an Australian population. I only use 6/24 samples in this example, which I have saved in this repo as a `minfi::RGChannelSet` object called `pl_rgset`.
...
```{r plot_results, fig.width=5, fig.height=2.5}
