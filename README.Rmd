...
In this example we are using term villi DNAm data, so we first load the reference cpgs `pl_cell_cpgs_third`. This is a data frame of 500 cpgs, with mean methylation levels for each cell type.
