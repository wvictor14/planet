...
`planet` is an R package for inferring ethnicity and gestational age from placental DNA methylation microarray data [\[1\]\[2\]](#references). 
...
2. [Lee Y, Choufani S, Weksberg R, et al. Placental epigenetic clocks: estimating gestational age using placental DNA methylation levels. Aging (Albany NY). 2019;11(12):4238–4253. doi:10.18632/aging.102049](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6628997/)
