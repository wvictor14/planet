...
*Note: currently, installing with R 3.6.0 results in an warning that can be circumvented with by setting  R_REMOTES_NO_ERRORS_FROM_WARNINGS="true" for the system environment variables*
